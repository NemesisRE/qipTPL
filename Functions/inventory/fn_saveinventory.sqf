...
_export = [
	...
	/* 06 */	[primaryweapon _center call qipTPL_fnc_baseWeapon,_center weaponaccessories primaryweapon _center,_primaryWeaponMagazine],
	/* 07 */	[secondaryweapon _center call qipTPL_fnc_baseWeapon,_center weaponaccessories secondaryweapon _center,_secondaryWeaponMagazine],
	/* 08 */	[handgunweapon _center call qipTPL_fnc_baseWeapon,_center weaponaccessories handgunweapon _center,_handgunMagazine],
...
_data = _namespace getvariable ["qipTPL_fnc_saveInventory_data",[]];
...
_namespace setvariable ["qipTPL_fnc_saveInventory_data",_data];
profilenamespace setvariable ["qipTPL_fnc_saveInventory_profile",true];
if !(isnil {profilenamespace getvariable "qipTPL_fnc_saveInventory_profile"}) then {saveprofilenamespace};
