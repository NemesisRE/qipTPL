...
_QS_ST_iconColor_EAST = [0.5,0,0,0.5];						// ARRAY (NUMBER). RGBA color code.	Default [0.5,0,0,0.65];
_QS_ST_iconColor_WEST = [0,0.3,0.6,0.5];					// ARRAY (NUMBER). RGBA color code. Default [0,0.3,0.6,0.65];
_QS_ST_iconColor_RESISTANCE = [0,0.5,0,0.5];					// ARRAY (NUMBER). RGBA color code. Default [0,0.5,0,0.65];
_QS_ST_iconColor_CIVILIAN = [0.4,0,0.5,0.5];					// ARRAY (NUMBER). RGBA color code. Default [0.4,0,0.5,0.65];
...
_QS_ST_iconSize_StaticWeapon = 18;							// NUMBER. Icon Size by Vehicle Type. Static Weapon (Mortar, remote designator, HMG/GMG. Default = 22
